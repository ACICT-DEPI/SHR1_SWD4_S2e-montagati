  ...
  Widget build(BuildContext context) {
    return   Row(
      ...
      children: [
        ...
        MaterialButton(onPressed:onpressed ,child: Text(navigate,style: Styles.text20(context).copyWith(fontSize: 19,color: Colors.white,),),padding: EdgeInsets.zero,minWidth: 0,),
      ],);
  }
}

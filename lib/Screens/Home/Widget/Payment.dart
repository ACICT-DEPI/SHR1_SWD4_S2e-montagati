...
final user=userDoc.set({
  ...
  "uid":FirebaseAuth.instance.currentUser!.uid
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('يرجى اختيار صورة وإدخال رقم الهاتف'), backgroundColor: Colors.red),
      );
    }
  }
              ...
              slivers: [
                ...
                SliverFillRemaining(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      padding: EdgeInsets.only(bottom: 25.0, top: 20),
                      child: GestureDetector(
                        onTap: _completePayment, // استدعاء دالة إتمام الدفع
                        child: Custombutton(title: 'اتمام عملية الدفع'),
                      ),
                    ),
                  ),
                ),
